...
def segment_kmeans(data, wavelengths, n_clusters=3, max_iter=50):
    ...
    kmeans = MiniBatchKMeans(n_clusters=n_clusters, max_iter=max_iter,
                              batch_size=1024, random_state=42, n_init=3)
...
def segment_pca(data, wavelengths, n_components=5, n_clusters=3):
    ...
    kmeans = MiniBatchKMeans(n_clusters=n_clusters, max_iter=50,
                              batch_size=1024, random_state=42, n_init=3)
...
def compare_methods(data, wavelengths, save_dir=None):
    ...
    if save_dir:
        ...
        fig.savefig(os.path.join(save_dir, "segmentation_comparison.png"),
